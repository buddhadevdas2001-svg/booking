          ...
          <Grid container spacing={6} alignItems="center">
            ...
            <Grid size={{ xs: 12, lg: 6 }}>
              <Paper sx={{ p: { xs: 3, md: 4 }, borderRadius: 1, ...GLASS_STYLE(theme) }}>
                <Typography variant="h5" sx={{ fontWeight: 800, mb: 3 }}>Quick Search</Typography>
                <Box component="form" onSubmit={handleSearch} sx={{ display: 'flex', flexDirection: 'column', gap: 2.5 }}>
                  ...
                  >
                    {isSearching ? 'Searching...' : 'Search Busses'}
                  </Button>
                </Box>
              </Paper>
            </Grid>
        ...
        <Grid container spacing={4} justifyContent="center">
          {loadingOffers
            ...
            : (offers.length > 0 ? offers : [
                { id: '1', code: 'VOYATRA10', description: 'Get flat 10% off on your first booking with Voyatra.', discount_type: 'percentage', discount_value: 10, valid_until: '2026-12-31' },
                { id: '2', code: 'WELCOME200', description: 'Welcome offer! Save ₹200 on bookings above ₹1000.', discount_type: 'fixed', discount_value: 200, valid_until: '2026-12-31' },
                { id: '3', code: 'STAYSAFE', description: 'Safety first! Exclusive discounts for vaccinated travelers.', discount_type: 'percentage', discount_value: 15, valid_until: '2026-12-31' },
              ]).map((offer, idx) => {
