        ...
        <div className="section-shell">
          ...
          <section className="mt-10 grid gap-6 md:grid-cols-3">
            <div className="card">
              ...
              <p className="mt-2 text-slate-600">Find buses quickly with a clean search experience and live availability.</p>
            </div>
            <div className="card">
              <h3 className="text-lg font-semibold">Real-Time Inventory</h3>
              <p className="mt-2 text-slate-600">Accurate seat and fare info with filters for AC/Non-AC and timings.</p>
            </div>
            <div className="card">
              <h3 className="text-lg font-semibold">Secure Checkout</h3>
              <p className="mt-2 text-slate-600">Fast and secure payment flows with popular gateways.</p>
            </div>
          </section>

          <section className="mt-10 rounded-2xl bg-slate-50 p-8">
            <h2 className="section-title">Our Mission</h2>
            <p className="mt-4 text-slate-600">We believe travel should be effortless — Voyatra connects you to buses across the country with transparent pricing and friendly UX.</p>
          </section>
        </div>
      </main>
    </div>
